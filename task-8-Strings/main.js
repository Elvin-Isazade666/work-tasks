//Task 1
//Mişa uşaklarla futbol oynamaq qərarına gəldi və evdən çixmağa hazırlaşırdı ki, bu zaman anası
//  onu yaxaladı və dedi ki, nə qədər ki, Mişa ona ev işlərində kömək etməsə,
//   futbol oynamağa getməyəcək. Seçim üçün anası Mişaya üç işdən birini görməsini təklif etdi: ya qabları yummalı, ya to
// zsoran ilə mənzili təmizləməli, ya da anası dükana gedənə qədər kiçik bacısı Mariya ilə oyunculu. Mişa hər bir reklamın ər vaxt alabilmesini hesabladı:
...
//Task 8
//Mətnlərin emalına aid sadə məsələlərdən biri sətirdəki hər bir sözün birinci hərfini baş hərfə çevirməkdir. Bir və ya bir neçə boşluqla ayrılmış kiçik hərflərdən
//  ibarət sətir verilmişdir. Eyni sətri, hər sözün birinci hərfini baş hərfə çevirərək çap edin.
